# receiver.py (完全修正版 - 已修復 AES 金鑰解包裝問題)
# 醫療影像接收方 - 負責接收和解密醫療影像
...
class Receiver:
    ...
    def receive_and_decrypt(self, transmission_package: dict, 
        ...
        try:
            ...
            sender_pub_pem = sender_cert['certificate_info']['public_key_pem'].encode('utf-8')
