...
class UploadTab:
    ...
    def setup_ui(self):
        ...
        # ========== Step 3: 上傳檔案 ==========
        step3 = Card(self.root)
        step3.pack(fill="both", expand=True, pady=(0, 0))
        s3 = ctk.CTkFrame(step3, fg_color="transparent")
        s3.pack(fill="both", expand=True, padx=PAD, pady=PAD)
        ...
        ctk.CTkLabel(
            format_frame,
            text="📁 支援影像: JPG, PNG, BMP, TIFF, DICOM (.dcm)",
            font=FONT["meta"], 
        ...
        ctk.CTkLabel(
            format_frame,
            text="🎬 支援影片: MP4, AVI, MOV, MKV, WMV, FLV, WebM",
            font=FONT["meta"], 
            text_color=COLOR["muted"]
    ...
    def filter_patients(self):
        ...
        for patient in filtered:
            ...
            info_text = f"MRN:{mrn} | 身分證:{national_id[-4:]}**** | 生日:{birthday}"
            ctk.CTkLabel(
                info_frame,
                text=info_text,
                font=FONT["meta"],
